...
const getMessage = overrides => {
  ...
  return {
    id: 5272,
    content: 'Hey, how are ya, I had a few questions about 1080 TIC?',
    inboxId: 475,
    conversationId: 43,
    messageType: 0,
    contentType: 'text',
...
const email = computed(() =>
  getMessage({
    ...
    attachments: [
      ...
      getAttachment('file', 'https://1080tic.dev/invoice.pdf'),
      getAttachment('file', 'https://1080tic.dev/logs.txt'),
      getAttachment('file', 'https://1080tic.dev/contacts.xls'),
      getAttachment('file', 'https://1080tic.dev/customers.csv'),
      getAttachment('file', 'https://1080tic.dev/warehousing-policy.docx'),
      getAttachment('file', 'https://1080tic.dev/pitch-deck.ppt'),
      getAttachment('file', 'https://1080tic.dev/all-files.tar'),
      getAttachment(
        'audio',
